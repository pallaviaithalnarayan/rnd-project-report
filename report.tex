...
\title{Evaluation of Semantic Segmentation using Artficial Training Data}

\author{Pallavi Aithal Narayan
        % <-this % stops a space
...
\thanks{$^{\dagger}$Supervised by Prof.~Dr.~Sebastian Houben (H-BRS) and Florian Oßwald~M.Sc. (H-BRS)}
\thanks{$^{\ddagger}$Submitted in Febraury 2025}} %
...
{Pallavi Aithal Narayan: Evaluation of Semantic Segmentation using Artficial Training Data}
